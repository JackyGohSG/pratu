...
if ( ! class_exists( 'CMP_Coming_Soon_and_Maintenance' ) ) :
	...
	class CMP_Coming_Soon_and_Maintenance {
		...
		public function cmp_premium_themes() {
			...
			array_push( $premium_themes, array('name' => 'atlas', 'url' => 'https://niteothemes.com/downloads/cmp-atlas-theme/?utm_source=cmp&utm_medium=referral&utm_campaign=atlas', 'price' => '10') );
